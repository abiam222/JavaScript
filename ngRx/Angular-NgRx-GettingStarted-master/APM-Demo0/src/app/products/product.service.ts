...
export class ProductService {
  private productsUrl = 'api/products';//get error if we mark this wrong 
  // private products: Product[];

  //For component communication you can also use
  //BehaviorSubject (Angular Component Communications)
  //We don't need below anymore because we are using actions and selectors
  // private selectedProductSource = new BehaviorSubject<Product | null>(null);
  // selectedProductChanges$ = this.selectedProductSource.asObservable();

  constructor(private http: HttpClient) { }

  //We don't need the following code because we are now using actions and selectors
